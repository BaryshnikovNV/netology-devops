...
Напишем переменные с валидацией:
```hcl
...
Для тестирования выполним команду ```terraform plan -var ''```.  
При правильном вводе адреса, terraform plan выпонляется успешно, в противном случае:

Скриншот 7 - Тестирование переменной с валидацией.
![Скриншот-7](/TER-35/ter/17.5-ter-05/img/17.5.4.1_Тестирование_переменной_с_валидацией.png)

Скриншот 8 - Тестирование переменной с валидацией.
![Скриншот-8](/TER-35/ter/17.5-ter-05/img/17.5.4.2_Тестирование_переменной_с_валидацией.png)
